...
/**
 * @title NumFiatSelfReferentialCollateral
 * @notice Collateral plugin for a Num vault with self referential collateral, like WETH
 * Expected: {tok} != {ref}, {ref} == {target}, {target} != {UoA}
 *
 * For example: Re7WETH
 */
contract NumFiatSelfReferentialCollateral is ERC4626FiatCollateral {
